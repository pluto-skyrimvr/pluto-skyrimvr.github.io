...
[NIF Preview](https://www.nexusmods.com/skyrimspecialedition/mods/69813): You can compare the differnce between 3D meshes easily.\
...
[Skyrim VR - USSEP 4.2.2 and SSE 1.5.97 Compatibility Patch](https://www.nexusmods.com/skyrimspecialedition/mods/31673): Follow the instructions in the mod page to generate a patch.\
...
## Creatures
[Bellyaches Animal and Creature Pack](https://www.nexusmods.com/skyrimspecialedition/mods/6839)\
...
[Placed Light](https://www.nexusmods.com/skyrimspecialedition/mods/135488): Choose Embers XD Timed, Clutter, Furniture, Dwemer, Dark Elf Lanterns, Nordic Columns and Halls, Falmer Stuff, College Lights, Magic and Enchants, Apocrypha light, Whiterun, Motes, Wisps, FEC Addon, Default for Lighting template, No for Synthesis patcher, PL - Exteriors. Synthesis patcher should be downloaded within Synthesis later.
...
## DynDOLOD ([DynDOLOD 3 Alpha](https://www.nexusmods.com/skyrimspecialedition/mods/68518))
...
* About LOOT: I made sure the proper load order of all mods in this page is updated in the latest LOOT material list. Clicking the Sort button in Plugins section of Mod Organizer 2 should take care of the proper plugin load order.
* The plugin load order will look like this: All mods -> Smashed Patch.esp -> Synthesis.esp -> DynDOLOD.esp -> Occlusion.esp
